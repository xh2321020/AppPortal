...
<div class="modal fade" :id="modal_id" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<h4 class="modal-title">部门列表123</h4>
      </div>
...
props:["supervisionRequest","selectedDepts","multiple","btn_title"],
	created(){
		...
		alert(this.supervisionRequest.orgURL + "    org")

		let _this=this;
		    $.ajax({
                type: "get",
                dataType: "json",
                url: this.supervisionRequest.orgUrl + "?apikey=" + window.interfaceSettings.personalpageRequest.header.apikey,
