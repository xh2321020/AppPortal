window.Base64=require("./components/jbase64.js");
window.Swiper=require('./components/swiper/idangerous.swiper.min2.7.6.js');
/*set the global ajax method*/
// if(window.pageName=="portal"){	
...
// }
/*get the webconfig json*/

$.ajax({
	url:location.protocol+"//"+location.host+'/dist/webconfig.json',
	type:"get",
	dataType:"json",
