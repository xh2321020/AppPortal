...
/***/ function(module, exports, __webpack_require__) {
	...
	var headerVm = new Vue({
	    el: "header",
	    components: { ComHeader: _header2.default }
	});

	var footerVm = new Vue({
	    el: "footer",
	    components: { ComFooter: _footer2.default }
	});
	var personalVm = new Vue({
	    ...
	    data: {
	        ...
	        personalread: [{
	            ...
	            "subject": "鍏充簬鎭宠鍚戝晢鍔￠儴浜氭床鍙告姤閫佸闊╁悎浣滄儏鍐垫姤鍛婄殑璇风ず"
	        }, {
	            ...
	            "creator": "20120013",
	            "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/",
	            "subject": "鍏充簬鍚勭浉鍏抽儴闂紙鍗曚綅锛夋姤閫佷笌鍥藉閮ㄥ鈥滃崄涓変簲鈥濊鍒掑鎺ヨ繘灞曟儏鍐电殑閫氱煡"
	        }, {
	            ...
	            "creator": "20120013",
	            "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/",
	            "subject": "鍏充簬涓浗鏍歌兘鐢靛姏鑲′唤鏈夐檺鍏徃閮ㄩ棬鑱岃矗璋冩暣鐨勯�氱煡"
	        }, {
	            ...
	            "creator": "20067119",
	            "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/",
	            "subject": "鍏充簬鎶ラ�佷腑鏍搁泦鍥㈡牳鐢靛巶鏍镐簨鏁呭満鍐呭簲鎬ユ敮鎻村熀鍦伴」鐩缓璁功鐨勮绀�"
	        }, {
	            ...
	            "creator": "20067119",
	            "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/",
	            "subject": "鍏充簬瀹℃煡銆婁腑鍥芥牳鑳界數鍔涜偂浠芥湁闄愬叕鍙告牳鐢甸」鐩墠鏈熷噯澶囧伐浣滄寚瀵兼剰瑙併�嬬殑璇风ず"
	        }],
	        //涓汉寰呭姙
	        personal: [{ "affairUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/processWorkflow.do?action=process&wobNum=6DC48F211B80D54A9F8581D5F919D4F0&stepName=Application", "created": "2013-09-11", "creator": "20120014", "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/", "subject": "涓浗鏍歌兘鐢靛姏鑲′唤鏈夐檺鍏徃N1-ECM绯荤粺绠＄悊瑙勫畾" }, { "affairUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/processWorkflow.do?action=process&wobNum=90C582442BD0394BBEB8BC4379E7E8F9&stepName=Undertake", "created": "2014-06-18", "creator": "htnpcws_z", "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/", "subject": "鍏充簬宸ョ▼寤鸿椤圭洰閫犱环瀹℃牳鎯呭喌鐨勫鍑�" }, { "affairUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/processWorkflow.do?action=process&wobNum=7E9286F1209EBC45A24EBA4EC89A0380&stepName=Establishment", "created": "2014-12-22", "creator": "20120014", "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/", "subject": "涓浗鏍歌兘鐢靛姏鑲′唤鏈夐檺鍏徃鎶曡祫绠＄悊鍒跺害" }, { "affairUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/processWorkflow.do?action=process&wobNum=2AEC6D7FBB2B6A45B2EEABDAD915F81F&stepName=Undertake", "created": "2015-08-20", "creator": "20120010", "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/", "subject": "鍏充簬寰佹眰銆婁腑鍥芥牳宸ヤ笟闆嗗洟鍏徃瀵瑰鎴樼暐鍚堜綔鍗忚绠＄悊鍔炴硶(寰佹眰鎰忚绋�)銆嬫剰瑙佺殑鍑�" }, { "affairUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/processWorkflow.do?action=process&wobNum=14F3697106CF2D43801E83A691206E37&stepName=Undertake", "created": "2015-08-19", "creator": "20120010", "moreUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/", "subject": "鍏充簬涓婃姤绉﹀北鏍哥數鏈夐檺鍏徃鍥藉厜瀹鹃鏀瑰崟韬叕瀵撳彲琛屾�х爺绌舵姤鍛婏紙浠ｅ垵姝ヨ璁★級鐨勬姤鍛�" }],
	        //鍏姙寰呭姙
	        public: [{
	            "affairUrl": "http://bjecm.cnnp.com.cn:80/cnnpbpm/web/processWorkflow.do?action=view&workflowNumber=7A6F1A0D42453C49ADE3BFDADF4DFDA0&workflowName=SendAdminLetterProcess&handID=1008141",
	            "created": "2016-06-02",
	        ...
	        dubanshixiang: [{
	            ...
	            "pcode": null,
	            "pname": null,
	            "name": "锛�夌粍缁囨垚鍛樺叕鍙镐笌鍦版柟鐗╀环灞�銆佺數缃戝湴鏂瑰眰闈㈢殑娌熼�氭眹鎶ヤ笌浜ゆ祦锛屼簤鍙栫悊瑙ｄ笌鏀寔锛涳紙2锛変簤鍙栬兘婧愬眬鐨勬敮鎸侊紝骞堕�氳繃鑳芥簮灞�褰卞搷浠锋牸鍙哥殑鍐崇瓥锛涳紙3锛夎繘涓�姝ュ姞寮洪檷鏈鏁堢鐞嗭紝鍔姏鍑忚交鐢典环鍙兘涓嬭皟鐨勪笉鍒╁奖鍝嶃�俓"",
	            "source": "MEETING",
	            "area": "HR",
	            "status": 0,
	            "importance": 1,
	            "urgency": 3,
	            "scope": "CNNPGMB",
	            "estimatedcompletetiontime": "2016-10-14",
	            "actualcompletetiontime": null,
	            "accountablesn": "20120022",
	            "accountablename": "闄堟ˇ",
	            "responsiblesn": null,
	            ...
	            "latestTrace": {
	                ...
	                "operatorname": null,
	                "rate": 30,
	                "description": "宸ヤ綔鐣ュ井婊炲悗锛屾暣浣撴寜鐓ц鍒掕繘琛�",
	    ...
	    ready: function ready() {
	        var _this = this;
	        var fetchArray = ["DUBANSHIXIANG", "PERSONAL", "PUBLIC", "PUBLICREAD", "PERSONALREAD"];
	        var nameArray = ["dubanshixiang", "personalred", "personal", "public", "publicread", "findcount"];
	        var tableHeader = "<section class='grid-table'><table class='table table-condensed head-title'><thead><tr><th > 浜嬮」鍚嶇О </th><th > 鍒涘缓浜哄憳 </th><th> 鍒涘缓鏃堕棿 </th></tr></thead><tbody>";
	        ...
	        for (var i = 0, len = fetchArray.length + 1; i < len; i++) {
	            ...
	            var datatypes = "";
	            var types = "";
	            if (fetchArray[i] == "PERSONAL") {
	                types = "post";
	                url = "http://bjecm.cnnp.com.cn/cnnpbpm/web/getPortalWorklist.do?action=PERSONAL&count=8";
	                datatypes = "json";
	            } else if (fetchArray[i] == "DUBANSHIXIANG") {
	                //return;
	                types = "post";
	                url = "http://172.16.51.137:8000/api/v1.0/supervision/search?page=0&size=50";
	                datas = (0, _stringify2.default)({ "accountablesn": "20120014" });
	                //currentUse = "20120014";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] assets\\src\\components\\header.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	//                         <a class="navbar-link com-portal" href="pages/portal/index.html">鍏徃闂ㄦ埛</a>
	//
	//                         <div class="nav-panel company">
	//                             <ul class="list">
	//                                 <li class="list-item"><a class="btn" href="http://bjportal.cnnp.com.cn/wps/portal"
	//                                                          target="_blank">涓浗鏍哥數鏃т富椤�/a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="http://www.cnnc.com.cn"
	//                                                          target="_blank">涓浗鏍稿伐涓氶泦鍥㈠叕鍙�/a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="http://10.16.15.38"
	//                                                          target="_blank">涓牳杩愯</a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="" target="_blank">涓禉鑳芥簮</a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn"
	//                                                          href="http://10.16.15.38:10039/wps/portal/Home/cnnc_index"
	//                                                          target="_blank">绉﹀北(绛�)</a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="#" target="_blank">姹熻嫃鏍哥數</a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="#" target="_blank">涓夐棬鏍哥數</a></li>
	//                                 <!-- /.list-item -->
	//                             </ul>
	//                             <ul>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="http://fqecm.cnnp.com.cn/wps/portal"
	//                                                          target="_blank">绂忔竻鏍哥數</a></li>
	//                                 <li class="list-item"><a class="btn" href="#" target="_blank">娴峰崡鏍哥數</a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="#" target="_blank">妗冭姳姹熸牳鐢�/a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="#" target="_blank">杈藉畞鏍哥數</a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="http://fsecm.cnnp.com.cn/wps/portal"
	//                                                          target="_blank">涓夋槑鏍哥數</a></li>
	//                                 <!-- /.list-item -->
	//                                 <li class="list-item"><a class="btn" href="http://zgecm.cnnp.com.cn/wps/portal"
	//                                                          target="_blank">婕冲窞鏍哥數</a></li>
	//                                 <!-- /.list-item -->
	...
	//                         <a class="navbar-link dep-portal">閮ㄩ棬鍙婁笓棰橀棬鎴�/a>
	//
	//                         <div class="nav-panel row">
	//                             <div class="list dept col-md-6">
	//                                 <p class="title">閮ㄩ棬闂ㄦ埛</p>
	//                                 <!-- /.title -->
	//                                 <ul>
	//                                     <li class="list-item"><a href="" class="btn">璁″垝鍙戝睍閮�/a></li>
	//                                     <!-- /.list-item -->
	//                                     <li class="list-item"><a href="" class="btn">璁″垝鍙戝睍閮�/a></li>
	//                                     <!-- /.list-item -->
	//                                     <li class="list-item"><a href="" class="btn">璁″垝鍙戝睍閮�/a></li>
	...
	//                         </div>
	//                     </li>
	//                     <li class="nav-list-item"><a class="navbar-link workbench" href="pages/portal/workspace.html">涓汉宸ヤ綔鍙�/a></li>
	//                 </ul>
	//             </div>
	//             <!-- /.nav-link -->
	//
	//             <ul class="nav-action" id="nav-action">
	//                 <li class="nav-list-item search"><input type="text" class="form-control" placeholder="鎼滅储" v-model="searchInputVal"/>
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Vue;
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(18), __webpack_require__(1)))
